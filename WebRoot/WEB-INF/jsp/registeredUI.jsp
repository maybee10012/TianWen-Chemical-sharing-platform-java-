...
<form id="form" name="form" action="${basePath }system/login_registered.action" method="post" enctype="multipart/form-data">
    <div class="p_d_1">
        <div class="p_d_1_1">
            <div class="content_info">
    <div class="c_crumbs"><div><b></b><strong>个人信息注册</strong>&nbsp;-&nbsp;注册账户</div></div>
    <div class="tableH2">注册账户</div>
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
        ...
        <tr>
         ...
         <tr>
          ...
          <tr>
            ...
            <td><s:radio list="#{'true':'男','false':'女'}" name="student.gender"/></td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="tdBg" width="200px">用户角色：</td>
            <td>
        ...
        <tr>
            ...
            <td><s:radio list="#{'1':'有效','0':'无效'}" name="student.state"/></td>
        </tr>
            <tr>
            <td  width="200">办公室：</td>
